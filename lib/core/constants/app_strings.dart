class AppStrings {
  ...
  static const String sleepAzkar = 'أذكار النوم';
  static const String wakeUpAzkar = 'أذكار الاستيقاظ';
  static const String prayerAzkar = 'أذكار بعد الصلاة';
  static const String duas = 'الأدعية';
  static const String sebha = 'السبحة';
  static const String prayerTimes = 'مواقيت الصلاة';
  static const String qibla = 'القبلة';
  static const String bookmarks = 'المفضلة';
  static const String favorites = 'المحفوظات';
